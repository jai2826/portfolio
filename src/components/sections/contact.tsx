        ...
        <AnimatedSection>
          <div className="text-center max-w-2xl mx-auto flex flex-col items-center rounded-2xl border border-zinc-800/60 bg-[#0a0a0a]/80 backdrop-blur-md p-8 md:p-14 shadow-[0_0_40px_rgba(0,0,0,0.6)]">
            ...
            <p className="text-zinc-400 text-lg mb-8 font-sans max-w-lg leading-relaxed">
              Have a project in mind, need a full-stack engineer, or want to collaborate? Feel free to reach out.
            </p>
            
            <a 
              href="mailto:jailakhmani12345@gmail.com" 
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#3B82F6] hover:bg-[#2563EB] px-8 py-4 text-base font-medium text-white shadow-[0_0_25px_rgba(56,189,248,0.25)] hover:shadow-[0_0_35px_rgba(0,217,255,0.4)] transition-all mb-10 font-sans hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <div className="flex items-center justify-center gap-6">
              <a 
                href="#" 
                className="text-zinc-400 hover:text-[#00D9FF] hover:scale-110 transition-all p-2 rounded-lg bg-zinc-900/60 border border-zinc-800" 
                aria-label="GitHub"
              >
